        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('professor.subjects.index')}}">Subjects</a></li>
                    <li class="breadcrumb-item active"><a href="{{ route('professor.chapters.index',$subject_id) }}">Chapters</a></li>
                </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header bg-success">
                    <h3 class="card-title">Add New Chapter</h3>
                </div>
                <!-- /.card-header -->
                <form action="{{ route('professor.chapters.store',$subject_id) }}" method="post" >
                    @csrf
                    <div class="card-body">  
